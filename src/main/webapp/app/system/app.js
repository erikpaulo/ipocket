...
function(angular, layout, config, dependencyResolverFor, errorHandler, menuHandler, authHandler)
{
    ...
    var app = angular.module('app', ['ngRoute', 'ui.grid', 'angularFileUpload', 'ui.grid.cellNav', 'ui.grid.autoResize', 'ui.grid.pinning', 'ui.grid.edit', 'ui.grid.selection', 'chart.js', 'highcharts-ng', 'ngResource', 'ngDragDrop', 'ui.select2', 'ui.bootstrap', 'ngCookies', 'tmh.dynamicLocale', 'pascalprecht.translate',  errorHandler.name, menuHandler.name, authHandler.name, 'app.directives', 'app.filters' ]);
